...
public class Pascal
{
  ...
  /**
   * Метод получает значения для реугольника Паскаля рекурсивно
   *
  ...
  /**
   * Метод получает значения для реугольника Паскаля рекурсивно с запоминанием вычисленных значений
   *
   * @param depth задает глубину рассчета треугольника Паскаля
   * @return массив значений  треугольника Паскаля
   */
  ...
  /**
   * Метод получает значения для реугольника Паскаля итеративно
   *
   * @param depth задает глубину рассчета треугольника Паскаля
   * @return массив значений  треугольника Паскаля
   */
