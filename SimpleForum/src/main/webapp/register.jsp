...
<main>
	...
	<form method="POST" action="">
	  ...
	  <div class="form-group row">
	    <label for="colFormLabelLg" class="col-sm-4 col-form-label">Enter the password again: </label>
	    <div class="col-sm-8">
	      <input type="password" class="form-control" id="colFormLabelLg" name="confirm_password">
	    </div>
	  </div>
